...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Sentence', fields ['state']
        db.create_index(u'bushes_sentence', ['state'])


    def backwards(self, orm):
        # Removing index on 'Sentence', fields ['state']
        db.delete_index(u'bushes_sentence', ['state'])
