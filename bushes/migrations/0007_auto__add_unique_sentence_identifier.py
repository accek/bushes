...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Sentence', fields ['identifier']
        db.create_unique(u'bushes_sentence', ['identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'Sentence', fields ['identifier']
        db.delete_unique(u'bushes_sentence', ['identifier'])
