...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sentence.superannotator'
        db.add_column(u'bushes_sentence', 'superannotator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sentence.superannotator'
        db.delete_column(u'bushes_sentence', 'superannotator_id')
    ...
    models = {
        ...
        u'bushes.sentence': {
            ...
            'superannotator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
